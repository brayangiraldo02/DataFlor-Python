...
export class CarouselComponent implements OnInit, OnDestroy {
  ...
  @Input() slides: SlideInterface[] = [
    { url: '/assets/img/carousel_amarillas.jpg', title: 'Margaritas amarillas' },
    { url: '/assets/img/carousel_girasol.jpg', title: 'Girasol' },
    { url: '/assets/img/carousel_rosa_rosada.jpg', title: 'Rosas rosadas' },
    { url: '/assets/img/carousel_moradas.jpg', title: 'Margaritas moradas' },
  ];
